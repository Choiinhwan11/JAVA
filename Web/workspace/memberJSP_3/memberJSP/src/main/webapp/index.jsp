...
<body>
	...
	<%} else { %>
		...
		<h3><a href="./board/boardWriteForm.jsp">글쓰기</a></h3>
     	<h3><a href="./board/boardList.jsp?pg=1">목록보기</a></h3>
     	<h3><a href="./guestbook/guestbookWriteForm.jsp">방명록 쓰기</a></h3>
     	<h3><a href="./guestbook/guestbookList.jsp?pg=1">방명록 보기</a></h3>
	<%} %>
</body>
</html>